...
st.markdown("This site usinging colabrative filtering suggests books from our catlog." "We recommend top 50 books for every one as well.")
...
def recommend(book_name):
    ...
    # let create empty list and in that list i want to populate with the book information
